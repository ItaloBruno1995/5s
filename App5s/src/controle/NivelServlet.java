...
/**
 * Servlet implementation class NivelServlet
 */
...
public class NivelServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		// VALIDAR NIVEIS :
		// SELETIVIDADE:
		if (request.getParameter("nivel").equalsIgnoreCase("1")) {
			System.out.println("ENTROU NO NIVEL 01");
		...
		// ENVIO DOS DADOS:
		nivel.seletividade(d1, d2, d3, usuarioLogado, empresa);
