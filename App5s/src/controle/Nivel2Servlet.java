...
/**
 * Servlet implementation class Nivel2Servlet
 */
@WebServlet("/Nivel2Servlet")
public class Nivel2Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Nivel2Servlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// RECUPERAR SESSOES:
				...
				// VALIDAR NIVEIS :
				// SELETIVIDADE:
				if (request.getParameter("nivel").equalsIgnoreCase("2")) {
